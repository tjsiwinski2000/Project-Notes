...
#     my_json_data= json.load(f1)

# print(type(my_json_data))
# my_json_data['512'] ={'name': 'Alice', 'role': 'Engineer', 'salary': 95000}

# with open(json_file_name,mode='w') as f2:
#     json.dump(obj=my_json_data,fp=f2)
...
print([num*num for num in range(1,100,2)])
...
my_data_frame = pandas.read_csv(my_data)


# gray = len(my_data_frame[my_data_frame["Primary Fur Color"] == "Gray"])
# # print(f'gray count:{gray}')
# black =len(my_data_frame[my_data_frame["Primary Fur Color"] == "Black"])
# red = len(my_data_frame[my_data_frame["Primary Fur Color"] == "Cinnamon"])
...
# my_second_df=pandas.DataFrame(my_dict)
# my_second_df.to_csv("0428.csv")
#================================================================
#================================================================
...
for k,v in users.items():
        print(f"Username: {k}\n\tFull name: {v['first'].title()} {v['last'].title()}\n\tLocation: {v['location'].title()}")
