...
class AlienInvasion:
    ...
    def _start_game(self):
        # Reset the game settings p283 ex14.1 slight deviation from text 
        self.settings.initialize_dynamic_settings
        self.stats.reset_stats()
        self.game_active = True
        # Get rid of of any remaining bullets and aliens.
        self.bullets.empty()
        self.aliens.empty()
        
        # Create a new fleet and cnter the ship.
        self._create_fleet()
    ...
    def _check_keydown_events(self,event):
        ...
        if event.key == pygame.K_RIGHT:
            ...
            #ex 14-1 p283 Start a new game when [P] is clicked
    ...
    def _update_aliens(self):
        ...
        #Look for aliens hitting hte bottom of the screen.
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            # alien reaches bottom when [bottom edge] > [height of screen]
